INSERT INTO App (AppId, Name, OwnerName, OwnerEmail) VALUES ('100003173','apollo-config-service','刘一鸣','liuym@ctrip.com');
...
INSERT INTO Cluster (AppId, Name) VALUES ('100003173', 'cluster1');
...
INSERT INTO AppNamespace (AppId, Name) VALUES ('100003173', 'fx.apollo.config');
...
INSERT INTO Namespace (Id, AppId, ClusterName, NamespaceName) VALUES (1, '100003173', 'default', 'application');
...
INSERT INTO Namespace (Id, AppId, ClusterName, NamespaceName) VALUES (5, '100003173', 'default', 'application');
...
INSERT INTO RELEASE (ReleaseKey, Name, Comment, AppId, ClusterName, NamespaceName, Configurations) VALUES ('TEST-RELEASE-KEY', 'REV1','First Release','100003173', 'default', 'application', '{"k1":"v1"}');
